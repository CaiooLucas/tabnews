      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-2 gap-px px-6 py-px md:grid-cols-4">
        {landing.stats.map((s) => (
          <div key={s.label} className="px-4 py-8 text-center md:text-left">
            <div className="wordmark text-3xl text-brand md:text-4xl">
              {s.value}
            </div>
...
function Audiences() {
  return (
    <section
      id="para-quem"
      className="border-y border-border/60 bg-background-deep/40"
    >
  ...
  return (
    <div
      className={`rounded-3xl border p-8 ${
        highlight ? "border-brand/40 bg-brand/5" : "border-border bg-muted/30"
      }`}
    >
