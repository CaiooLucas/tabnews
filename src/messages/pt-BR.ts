const ptBR = {
  ...
  landing: {
    ...
    stats: [
      ...
      {
        value: "100%",
        label: "dos contratos digitais e armazenados na plataforma",
      },
      {
        value: "1º mês",
        label: "grátis para o motorista, sem fricção de adoção",
      },
      {
        value: "B2C / B2B2C",
        label: "responsáveis, motoristas e escolas em um só lugar",
      },
    ],
    problem: {
      eyebrow: "O problema",
